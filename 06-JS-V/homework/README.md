...
* Prototype es una propiedad de Object( el objeto de donde derivan todos los demas) y esta misma propiedad es un objeto. sirve para proporcionar mecanismos de herencia.

* Se denomina constructor al codigo que se ejecuta cuando se crea un objeto de un tipo determinado y a cada objeto se lo llama instancia, todas las clases tienen un constructor. 
